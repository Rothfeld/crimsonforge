...
CHANGELOG: list[tuple[str, str, list[str]]] = [
    (
        "1.23.0", "2026-05-01", [
            ...
            "[Thanks] Thank you to @imedox for the prior pull-request contributions (#1 audio enhancements + PAZ search, #6 main rebase, #7 OmniVoice advanced parameters, #8 audio patching collision fix). Those merges shipped in v1.17.0 / v1.22.2 / community contributions and laid the groundwork that the v1.22.x and v1.23.0 mesh / animation work builds on top of.",
        ],
    ),
    (
        "1.22.9", "2026-04-24", [
